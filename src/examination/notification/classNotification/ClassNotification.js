...
import { GET_ALL_TEACHER_NOTIFICATION_TEACHER_RESET, GET_LIST_TEACHER_NOTIFICATION_TEACHER_RESET } from "./ClassNotificationConstants";
import { getAllNotificationTeacherAction, getListNotificationTeacherAction } from "./ClassNotificationActions";
...
const useStyles = makeStyles((theme) => ({
  ...
  const ClassNotification = () => {
    ...
    const { listClassNotificationTeacher, error: listClassNotificationTeacherError } =
        ...
        <TableContainer className={classes.table}>
          ...
          <TableBody>
            {tableDataAfterPagingAndSorting().map((item) => (
              <ClassNotificationTeacherTableCollapse item={item} key={item.$id} />
            ))}
          </TableBody>
        </TableContainer>
        <TblPagination />
